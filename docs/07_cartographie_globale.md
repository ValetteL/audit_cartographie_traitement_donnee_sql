...
5. **L'analyse finale** répond à la problématique initiale à l'échelle communale, avec ses limites documentées (petits effectifs, valeur aberrante, corrélation ≠ causalité).
